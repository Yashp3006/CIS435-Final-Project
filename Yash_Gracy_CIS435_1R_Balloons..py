...
Original file is located at
    https://colab.research.google.com/drive/12PFAwMwP1wiD0-ZIPRg1HBAFS_rZqZeM
"""
...
if __name__ == "__main__":
    train_file = "/content/balloons_train.txt"  # Update path if using locally
    test_file = "/content/balloons_test.txt"  # Update path if using locally
