...
Original file is located at
    https://colab.research.google.com/drive/1pOpJL8DXrVAu5UX5Gkv6lKbTcaDxcG-3
"""
...
def main():
    try:
        ...
        train_data = pd.read_csv("/content/mysterious_train.txt", header=None, sep=" ")
        test_data = pd.read_csv("/content/mysterious_test.txt", header=None, sep=" ")
